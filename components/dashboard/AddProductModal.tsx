...
const AddProductModal = ({ isOpen, onClose }:AddProductModalProps) => {
    ...
    console.log("File response when upload",file)
    ...
    const handleSubmit = async (values: FormValues) => {
        ...
        try {
            const response = await createProduct({name: values.name, description: values.description, price: values.price, quantity: values.quantity, categoryName: values.categoryName, brandName: values.brandName, image: images});
