...
import DeleteBrandModal from "@/components/dashboard/brand/DeleteBrandModal";
...
const BrandTable = () => {
    ...
    return (
        <div className="px-4 sm:px-6 lg:px-8">
            ...
            <DeleteBrandModal isOpen={isDeleteModalOpen} onClose={closeDeleteModal} product={selectedProduct}/>
            <AddBrandModal isOpen={isModalOpen} onClose={closeModal}/>
            <UpdateBrandModal isOpen={isEditModalOpen} onClose={closeEditModal} product={selectedProduct}/>
        </div>
    );
};
